...
| `showTransparentSlot`    | boolean                                                                                                 | false   | Flag to display a transparent slot at the start of the slot list. It is not rendered while the groups are displayed; a compact palette is one flat strip, so it is rendered there whatever the shape of `colors`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
Compact mode ignores the grouping. A grouped `colors` list collapses into one flat strip rendered through the same markup as a flat palette — the group names, the per-group `group` roles and the per-group grids are gone while the palette is compact — and enlarging restores the groups.
