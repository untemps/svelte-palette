...
| `numColumns`             | number   | 5       | Number of columns to display the color slots. This value can't exceed the number of maximum colors defined in `maxColors` and can't be lower than 1. Set this value to `0` to display the slots on a single row. |
