...
| `allowDuplicates`        | boolean                                                                                                 | false   | Flag to allow color duplication. When `false` the palette renders one slot per distinct color — per group in grouped mode — and deleting that slot removes every entry it stands for (see [Deletion Modes](#deletion-modes)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
