...
| `showInput`              | boolean                                                                                                 | false         | Flag to display the input within the footer slot. The input is not rendered in compact mode, in grouped mode, or while an async `colors` source is still unresolved.                                                                                                                                                                                                                        |
