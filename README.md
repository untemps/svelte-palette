...
| `compactColorIndices`    | number[]                                                                                                | []      | Array of indices to pick from the `colors` array to be displayed in the compacted palette (see [Compact Mode](#compact-mode)). Supports `bind:compactColorIndices`: deleting a slot from the flat or the compact palette re-indexes it, and drops any index whose color the deletion removed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
