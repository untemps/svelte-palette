...
| `maxColors`              | number                                                                                                  | 30      | Maximum number of slots to be displayed in the palette. Set this value to `-1` to allow infinite number of slots. In grouped mode the cap applies to each group rather than to the palette. Colors beyond the cap stay in the list and are handed back to `bind:colors` and to the callbacks; deleting a rendered slot pulls the next one into view.                                                                                                                                                                                                                                                                                                                                                                                            |
